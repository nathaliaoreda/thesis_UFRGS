...
models_list <- c("ar_rw_aic","ar_rw_cv","shrink_poor_rw_cv_ridge","shrink_poor_rw_cv_lasso","shrink_poor_rw_cv_en","rf_poor_rw_cv","bols_poor_rw_cv","bbs_poor_rw_cv","svr_linear_poor_rw_cv","svr_rbf_poor_rw_cv",
                 "ardi_rw_bic","ardi_rw_aic","ardi_rw_cv","shrink_rich_rw_cv_ridge","shrink_rich_rw_cv_lasso","shrink_rich_rw_cv_en","rf_rich_rw_cv","bols_rich_rw_cv","bbs_rich_rw_cv","svr_linear_rich_rw_cv","svr_rbf_rich_rw_cv",
                 "b1_rw_cv_boost","b1_rw_cv_ridge","b1_rw_cv_en","b1_rw_cv_lasso","b2_rw_cv_boost","b2_rw_cv_ridge","b2_rw_cv_en","b2_rw_cv_lasso","b3_rw_cv_boost","b3_rw_cv_ridge","b3_rw_cv_en","b3_rw_cv_lasso")
...
columns_to_exclude <- c("shrink_poor_rw_cv_lasso","shrink_poor_rw_cv_en","b2_rw_cv_lasso", "b3_rw_cv_lasso", "b2_rw_cv_en")
...
columns_to_exclude <- c("shrink_poor_rw_cv_lasso","shrink_poor_rw_cv_en","b1_rw_cv_en","b2_rw_cv_lasso", "b3_rw_cv_lasso", "b2_rw_cv_en", "b3_rw_cv_en")
...
columns_to_exclude <- c("shrink_poor_rw_cv_lasso","shrink_poor_rw_cv_en","b1_rw_cv_en","b2_rw_cv_lasso", "b3_rw_cv_lasso", "b2_rw_cv_en", "b3_rw_cv_en","ardi_rw_aic")
SPREAD_6 <- SPREAD_6[, -which(colnames(SPREAD_6) %in% columns_to_exclude)]
IPCA_6 <- results$squared_error[["PRECOS12_IPCA12_6"]]
columns_to_exclude <- c("b2_rw_cv_lasso", "b3_rw_cv_lasso", "b2_rw_cv_en","ardi_rw_aic")
...
SPREAD_3_CSFE_df <- SPREAD_3_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(svr_linear_poor_rw_cv, b1_rw_cv_lasso,bols_rich_rw_cv,bbs_poor_rw_cv, bols_poor_rw_cv, svr_rbf_rich_rw_cv, bbs_rich_rw_cv, ar_rw_aic, shrink_rich_rw_cv_ridge, svr_linear_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
SPREAD_6_CSFE_df <- SPREAD_6_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b3_rw_cv_boost, b2_rw_cv_boost,svr_linear_poor_rw_cv, b1_rw_cv_lasso, bols_poor_rw_cv, bols_rich_rw_cv,ar_rw_aic,svr_rbf_rich_rw_cv,bbs_rich_rw_cv,shrink_poor_rw_cv_ridge,dates) %>%
  gather(key = "Model", value = "value", -dates)
SPREAD_9_CSFE_df <- SPREAD_9_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(ar_rw_aic,b3_rw_cv_boost,b2_rw_cv_boost,shrink_poor_rw_cv_ridge,svr_linear_poor_rw_cv,b1_rw_cv_lasso,bols_poor_rw_cv, b1_rw_cv_boost, bbs_rich_rw_cv,svr_linear_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
SPREAD_12_CSFE_df <- SPREAD_12_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(svr_linear_poor_rw_cv,bols_poor_rw_cv, shrink_poor_rw_cv_ridge,ar_rw_aic, b1_rw_cv_lasso, bbs_rich_rw_cv, b1_rw_cv_boost, svr_rbf_rich_rw_cv,b2_rw_cv_boost,ar_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
...
IPCA_1_CSFE_df <- IPCA_1_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b1_rw_cv_lasso,b3_rw_cv_lasso,b2_rw_cv_lasso,b2_rw_cv_en,b2_rw_cv_boost,b3_rw_cv_ridge,b2_rw_cv_ridge,b1_rw_cv_ridge,svr_rbf_rich_rw_cv,b1_rw_cv_en,dates) %>%
  gather(key = "Model", value = "value", -dates)
IPCA_3_CSFE_df <- IPCA_3_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b3_rw_cv_boost,rf_rich_rw_cv,b1_rw_cv_boost,b2_rw_cv_boost,b3_rw_cv_ridge,b3_rw_cv_en,b1_rw_cv_en,b1_rw_cv_lasso,b2_rw_cv_ridge,bbs_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
IPCA_6_CSFE_df <- IPCA_6_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b3_rw_cv_en,b1_rw_cv_lasso,b1_rw_cv_en,b2_rw_cv_boost,svr_rbf_rich_rw_cv,b3_rw_cv_boost,bbs_rich_rw_cv,ar_rw_cv,b1_rw_cv_boost,bols_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
IPCA_9_CSFE_df <- IPCA_9_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b1_rw_cv_lasso,b3_rw_cv_en,b1_rw_cv_en,b2_rw_cv_boost,svr_rbf_rich_rw_cv,b3_rw_cv_boost,ar_rw_cv,bbs_rich_rw_cv,svr_rbf_poor_rw_cv,bols_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
IPCA_12_CSFE_df <- IPCA_12_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b1_rw_cv_lasso,b1_rw_cv_en,b3_rw_cv_en,b2_rw_cv_boost,b3_rw_cv_boost,svr_rbf_rich_rw_cv,bols_rich_rw_cv,shrink_rich_rw_cv_ridge,svr_rbf_poor_rw_cv,bbs_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
...
UNRATE_1_CSFE_df <- UNRATE_1_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(rf_rich_rw_cv,svr_rbf_rich_rw_cv,b1_rw_cv_en,b1_rw_cv_lasso,b1_rw_cv_ridge,b2_rw_cv_en,b2_rw_cv_lasso,b3_rw_cv_ridge,b3_rw_cv_en,b3_rw_cv_lasso,dates) %>%
  gather(key = "Model", value = "value", -dates)
UNRATE_3_CSFE_df <- UNRATE_3_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b3_rw_cv_en,b1_rw_cv_lasso,b1_rw_cv_en,b3_rw_cv_lasso,b2_rw_cv_en,b3_rw_cv_ridge,b2_rw_cv_lasso,b2_rw_cv_ridge,svr_rbf_rich_rw_cv,rf_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
UNRATE_6_CSFE_df <- UNRATE_6_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(b3_rw_cv_ridge,b1_rw_cv_en,b2_rw_cv_ridge,b3_rw_cv_en,b1_rw_cv_lasso,b2_rw_cv_en,svr_rbf_rich_rw_cv,shrink_poor_rw_cv_ridge,b2_rw_cv_boost,b3_rw_cv_boost,dates) %>%
  gather(key = "Model", value = "value", -dates)
UNRATE_9_CSFE_df <- UNRATE_9_CSFE %>%
  as.data.frame()%>%
  mutate(dates = seq(as.Date("2009-01-01"), by = "month", length.out = 125))%>%
  select(svr_rbf_rich_rw_cv,b1_rw_cv_en,b3_rw_cv_en,b1_rw_cv_lasso,b2_rw_cv_en,b3_rw_cv_ridge,b2_rw_cv_ridge,shrink_poor_rw_cv_ridge,bbs_poor_rw_cv,rf_rich_rw_cv,dates) %>%
  gather(key = "Model", value = "value", -dates)
